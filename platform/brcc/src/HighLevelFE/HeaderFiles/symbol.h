...
class SymEntry
{
  public:
    ...
    {
        return (type == TypedefEntry);
    }
    bool IsVarDecl() const
    {
        return (type == VarDeclEntry);
    }
    bool IsFctDecl() const
    {
        return (type == FctDeclEntry);
    }
    bool IsVarFctDecl() const
    {
        return (type == VarFctDeclEntry);
    }
    bool IsParamDecl() const
    {
        return (type == ParamDeclEntry);
    }
    bool IsEnumConst() const
    {
        return (type == EnumConstEntry);
    }
    bool IsComponentDecl() const
    {
        return (type == ComponentEntry);
    }

    bool IsTagDecl() const
    {
        return (type == TagEntry);
    }
    bool IsLabelDecl() const
    {
        return (type == LabelEntry);
    }

    SymEntryType SymType()
    {
        return type;
    }
...
#if BROOK_TO_IL_CODE_GEN_PATH
    bril::store * get_il_store();

    std::string getILRegName(bril::reg_style style);
...
class Symbol
{
  public:
    ...
    {
        if (entry)
            return entry->getILRegName(style);
        else
            return name;
    }
#endif 
