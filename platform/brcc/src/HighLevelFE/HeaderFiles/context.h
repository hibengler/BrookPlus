...
#ifndef INC_CT_CONTEXT_H
#define INC_CT_CONTEXT_H
...
protected:
    bool IsTypedefDeclCtxt(void)
        {
            LOG(LOG_FN_ENTRY, "IsTypedefDeclCtxt()\n");
