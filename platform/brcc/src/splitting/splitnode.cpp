...
SplitNode::SplitNode():inferredType(kSplitBasicType_Unknown)
{
    _spanningParent = 0;
    _spanningNodeID = 0;
...
{
    if (_linkEvalAncestor->_linkEvalAncestor == NULL)
        return;
...
IteratorArgumentSplitNode::IteratorArgumentSplitNode(const std::string & inName, SplitBasicType inType,
                                                     int inArgumentIndex):AssignableArgumentSplitNode(inName, inType,
                                                                                                      inArgumentIndex)
{
    _value = new InputInterpolantSplitNode(argumentIndex, 0, inferredType);
}

OutputArgumentSplitNode::OutputArgumentSplitNode(const std::string & inName, SplitBasicType inType, int inArgumentIndex,
                                                 SplitTreeBuilder & ioBuilder):IndexofableSplitNode(inName, inType,
                                                                                                    inArgumentIndex)
{
    SplitNode *interpolant = ioBuilder.getOutputInterpolant();

    indexofConstant =
        new InputConstantSplitNode(argumentIndex,::brook::desc::kOutputConstant_Indexof, kSplitBasicType_Float4);
    ...
    _indexofValue = ioBuilder.addConstructor(kSplitBasicType_Float4,
                                             ioBuilder.addBinaryOp("+",
                                                                   ioBuilder.addBinaryOp("*", interpolant,
                                                                                         ioBuilder.
                                                                                         addMember(indexofConstant,
                                                                                                   "xy")),
                                                                   ioBuilder.addMember(indexofConstant, "zw")),
                                             ioBuilder.addConstant(0), ioBuilder.addConstant(0));
}

StreamArgumentSplitNode::StreamArgumentSplitNode(const std::string & inName, SplitBasicType inType, int inArgumentIndex,
                                                 SplitTreeBuilder & ioBuilder):IndexofableSplitNode(inName, inType,
                                                                                                    inArgumentIndex)
{
    ...
    indexofConstant =
        new InputConstantSplitNode(argumentIndex,::brook::desc::kStreamConstant_Indexof, kSplitBasicType_Float4);
...
GatherArgumentSplitNode::GatherArgumentSplitNode(const std::string & inName, SplitBasicType inType, int inArgumentIndex,
                                                 SplitTreeBuilder & ioBuilder):ArgumentSplitNode(inName, inType,
                                                                                                 inArgumentIndex)
{
    sampler = new InputSamplerSplitNode(argumentIndex, 0, inferredType);
...
ConstantArgumentSplitNode::ConstantArgumentSplitNode(const std::string & inName, SplitBasicType inType,
                                                     int inArgumentIndex):AssignableArgumentSplitNode(inName, inType,
                                                                                                      inArgumentIndex)
{
...
BrtMemberSplitNode::BrtMemberSplitNode(SplitNode * inValue, const std::string & inName):value(inValue), name(inName)
{
...
UnaryOpSplitNode::UnaryOpSplitNode(const std::string & inOperation, SplitNode * inOperand):_operation(inOperation),
_operand(inOperand)
{
...
BrtBinaryOpSplitNode::BrtBinaryOpSplitNode(const std::string & inOperation, SplitNode * inLeft,
                                           SplitNode * inRight):operation(inOperation), left(inLeft), right(inRight)
{
...
FunctionCallSplitNode::FunctionCallSplitNode(const std::string & inName,
                                             const std::vector < SplitNode * >&inArguments):_name(inName),
...
ConditionalSplitNode::ConditionalSplitNode(SplitNode * inCondition, SplitNode * inConsequent, SplitNode * inAlternate):_condition(inCondition), _consequent(inConsequent),
    _alternate
    (inAlternate)
{
