...
// splitnode.h
#ifndef INC_SPLITNODE_H
#define INC_SPLITNODE_H
...
class SplitNode
{
  public:
    ...
    virtual bool needsArgument()
    {
        return false;
    }
    virtual void printArgumentInfo(std::ostream & UNUSED(inStream), SplitArgumentCounter & UNUSED(ioCounter))
    {
    }
    virtual bool needsTemporaryExpression()
    {
        return true;
    }
    virtual bool needsTemporaryVariable()
    {
        return true;
    }
    ...
    virtual bool needsAnnotation()
    {
        return false;
    }
    virtual void printAnnotationInfo(std::ostream & UNUSED(inStream))
    {
    }

    virtual void assign(SplitNode * UNUSED(inValue))
    {
        throw 1;
    }

    virtual GatherArgumentSplitNode *isGatherArgument()
    {
        return 0;
    }
    virtual StreamArgumentSplitNode *isStreamArgument()
    {
        return 0;
    }
    virtual IndexofableSplitNode *isIndexofable()
    {
        return 0;
    }
...
class SplitRootNode:public SplitNode
{
  public:
    ...
    void printTemporaryExpression(std::ostream & UNUSED(inStream))
    {
    }
    void printExpression(std::ostream & UNUSED(inStream))
    {
    }
};
...
{
  public:
    InputSplitNode(int inArgumentIndex, int inComponentIndex):argumentIndex(inArgumentIndex),
...
{
  public:
    InputSamplerSplitNode(int inArgumentIndex, int inComponentIndex,
                          SplitBasicType inType):InputSplitNode(inArgumentIndex, inComponentIndex)
    {
        inferredType = inType;
    }
    ...
    virtual const char *getComponentTypeName()
    {
        return "s";
    }
...
{
  public:
    InputConstantSplitNode(int inArgumentIndex, int inComponentIndex,
                           SplitBasicType inType):InputSplitNode(inArgumentIndex, inComponentIndex)
    {
        inferredType = inType;
    }
...
{
  public:
    InputInterpolantSplitNode(int inArgumentIndex, int inComponentIndex,
                              SplitBasicType inType):InputSplitNode(inArgumentIndex, inComponentIndex)
    {
        inferredType = inType;
    }
...
{
  public:
    LocalVariableSplitNode(const std::string & inName, SplitBasicType inType):_name(inName), _value(0)
    {
        inferredType = inType;
    }
...
{
  public:
    ArgumentSplitNode(const std::string & inName, SplitBasicType inType, int inArgumentIndex):name(inName),
...
{
  public:
    AssignableArgumentSplitNode(const std::string & inName, SplitBasicType inType,
                                int inArgumentIndex):ArgumentSplitNode(inName, inType, inArgumentIndex),
        _assignedValue(0)
    {
    }
...
{
  public:
    IndexofableSplitNode(const std::string & inName, SplitBasicType inType,
                         int inArgumentIndex):AssignableArgumentSplitNode(inName, inType, inArgumentIndex),
        _indexofValue(0)
    {
    }
...
{
  public:
    ReduceArgumentSplitNode(const std::string & inName, SplitBasicType inType,
                            int inArgumentIndex):AssignableArgumentSplitNode(inName, inType, inArgumentIndex)
    {
    }
};
...
class IteratorArgumentSplitNode:public AssignableArgumentSplitNode
{
  public:
    ...
    virtual SplitNode *getValueNode()
    {
        return _assignedValue ? _assignedValue : _value;
    }
...
{
  public:
    StreamArgumentSplitNode(const std::string & inName, SplitBasicType inType, int inArgumentIndex,
                            SplitTreeBuilder & ioBuilder);

    virtual SplitNode *getValueNode()
    {
        return _assignedValue ? _assignedValue : value;
    }
...
{
  public:
    GatherArgumentSplitNode(const std::string & inName, SplitBasicType inType, int inArgumentIndex,
                            SplitTreeBuilder & ioBuilder);
    InputSamplerSplitNode *getSampler()
    {
        return sampler;
    }
    SplitNode *getScale()
...
class BrtConstantSplitNode:public SplitNode
{
  public:
...
class BrtMemberSplitNode: public SplitNode
{
  public:
...
class UnaryOpSplitNode: public SplitNode
{
  public:
...
class BrtBinaryOpSplitNode: public SplitNode
{
  public:
...
class TextureFetchSplitNode: public SplitNode
{
  public:
...
class ConstructorSplitNode: public SplitNode
{
  public:
    ConstructorSplitNode(SplitBasicType inType, const std::vector < SplitNode * >&inArguments):arguments(inArguments)
    {
        inferredType = inType;
...
class CastSplitNode: public SplitNode
{
  public:
    CastSplitNode(SplitBasicType inType, SplitNode * inValue):_value(inValue->getValueNode())
    {
        inferredType = inType;
        addChild(_value);
    }
...
class FunctionCallSplitNode: public SplitNode
{
  public:
...
class ConditionalSplitNode: public SplitNode
{
  public:
