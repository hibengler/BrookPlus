...
SplitNodeSet::iterator::iterator(const SplitNodeSet & inSet, size_t inIndex):index(inIndex), set(inSet)
{
    validate();
}
...
SplitNodeSet::iterator SplitNodeSet::begin()constconst
{
    return iterator(*this, 0);
}

SplitNodeSet::iterator SplitNodeSet::end()constconst
{
