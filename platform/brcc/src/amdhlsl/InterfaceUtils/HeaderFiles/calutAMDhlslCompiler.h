...
#ifndef _CALUT_AMDHLSL_COMPILER_H_
#define _CALUT_AMDHLSL_COMPILER_H_
 ...
 * 
 */
enum CALUT_OUTPUT_FORMAT {
    CALUT_OUTPUT_FROMPARAMS = 1,
    CALUT_OUTPUT_TXT = 2,
    CALUT_OUTPUT_BIN = 3,
    CALUT_OUTPUT_HEX = 4
}; // CALUT_OUTPUT_FORMAT
...
/**
 * @fn calutAMDhlslCompileProgram(CALobject* object, CALtarget target, const char* kernel_source, CALtarget, CALUT_OUTPUT_FORMAT target_format)
 *
 * @brief Compile a HLSL shader into a CALobject
 *
 * Compiles HLSL text into IL binary and then packs this binary along
 * with the shader meta data into a CALobject.
 *
 * @return Returns CAL_TRUE on success
 */
...
calutAMDhlslCompileProgram( CALobject*		object,
                            ...
                            CALtarget		target,
                            CALUT_OUTPUT_FORMAT	target_format = CALUT_OUTPUT_HEX );

/**
 * @fn calutAMDhlslGetLastError()
 *
 * @brief retrieves that last error during compilation
 *
 * @return Returns that last error during compilation
 */
...
#endif // _CALUT_AMDHLSL_COMPILER_H_
