...
#ifndef AMD_ILTEXTTRANSCRIBER_HPP
#define AMD_ILTEXTTRANSCRIBER_HPP

#include "iltranscriber.hpp"

class ILTextTranscriber : public ILTranscriber
{
public:
  ILTextTranscriber(std::ostream& t) : ILTranscriber(t) {}
...
protected:
  ...
  virtual void op_resource(const char* txt , ILSpec::ILOpCode bin ,
                           ILRegister d, int resource, int sampler,
...
#endif // AMD_ILTEXTTRANSCRIBER_HPP
