...
#ifndef AMD_HLFRONTEND_PARSER_HPP
#define AMD_HLFRONTEND_PARSER_HPP

#include <iostream>

#include "parservariant.hpp"
#define YYSTYPE ParserVariant

//! define YYTOKENTYPE just to avoid clash between enums defined under yytokentype tag in parser.tab.hpp  
//! and standard header enums in windows
#ifdef _WIN32
#define YYTOKENTYPE
#endif

//for all the enumerated types
#include "parser.tab.hpp"

//this needs to be declared for the bison stuff to compile in c++ mode
int zzlex();

//Following are called/set from main
int zzparse();

extern bool        theParserHadError;
extern std::ostream* theDumpCppFile;
