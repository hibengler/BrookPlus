////////////////////////////////////////////////////////////////////////////////
//!
//! \file   gather_stream_kernel.cpp
//!
//! \brief  Create and execute a transpose kernel which uses gather stream
//!
////////////////////////////////////////////////////////////////////////////////

// Project headers
#include "brookgenfiles/transpose.h"
...
main(int argc, char* argv[])
{
    ...
    unsigned int streamSizeT[] = {height, width};
    brook::Stream<float> outputStream(rank, streamSizeT);
    ...
    transposeGPU(inputStream, outputStream);

    // Creating GPU output buffer & CPU output buffer
