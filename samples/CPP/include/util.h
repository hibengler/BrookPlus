...
//! \file   util.h
//!
//! \brief  Declares the utility functions
//! 
////////////////////////////////////////////////////////////////////////////////
...
typedef struct brTagBITMAPFILEHEADER {
    unsigned short bfType;
    unsigned int bfSize;
    unsigned short bfReserved1;
    unsigned short bfReserved2;
    unsigned int bfOffBits;
} BRBITMAPFILEHEADER, *BRPBITMAPFILEHEADER;

typedef struct brTagBITMAPINFOHEADER {
    unsigned int biSize;
...
} BRBITMAPINFOHEADER, *BRPBITMAPINFOHEADER;

typedef struct brTagRGBQUAD {
...
extern unsigned int padWidth;
extern unsigned int byteWidth;
extern unsigned int datasize;
extern const short BITMAP_MAGIC_NUMBER;
extern const int RGB_BYTE_SIZE;
...
namespace Util
{
    ...
    //! \enum   BufferValue
    //!
    //! \brief  Enums representing various data generation techniques
    //! 
    ////////////////////////////////////////////////////////////////////////////////
    ...
    void
    calculatePerformance(const unsigned int width, const unsigned int height,
                            const unsigned int depth, const unsigned int operationsPerElement, 
                            double time);
    
    void
    normalizeMatrix(float4* matrix, 
                    unsigned int width, unsigned int height,
                    float min, float max);

    float4*
    openImage(const std::string filename, unsigned int& width, unsigned int& height);

    void
    saveImage(const std::string filename, float4* data,
