...
//! \file   SampleBase.h
//!
//! \brief  Declares and defines the template class SampleBase
//! 
////////////////////////////////////////////////////////////////////////////////
...
//! \class  SampleBase
//!
//! \brief  Base class for writing samples
//! 
////////////////////////////////////////////////////////////////////////////////
...
{   
    public:
        ...
        SampleBase(char* sampleName);
        virtual ~SampleBase();
        virtual void ParseCommandLine(int argc, char** argv);
        virtual void allocateBuffer();
        virtual void fillInputBuffer();
        virtual int run() = 0;
        virtual void printTimeInfo();
        virtual void verifyResults();
        virtual void comparePerformance();
        virtual void Usage(char *name);
...
//! \class  InfoRec
//!
//! \brief  Keeps track on user inputs
//! 
////////////////////////////////////////////////////////////////////////////////
...
class InfoRec
{
    public:
        ...
        InfoRec()
            :Verbose(DEFAULT_VERBOSE), Verify(DEFAULT_VERIFY), Performance(0), Seed(DEFAULT_SEED),
            Quiet(DEFAULT_QUIET), Timing(DEFAULT_TIMING), Height(DEFAULT_HEIGHT), Width(DEFAULT_WIDTH),
